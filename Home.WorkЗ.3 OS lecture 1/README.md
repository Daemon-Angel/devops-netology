...
#### Ответ:
Оба оператора последовательно выполняют несколько команд.
...
Использовать set -e - не имеет смысла, т.к. при ошибке выполнение команд прекратится.
...
Дополнительные символы - это доп характеристики, например как приоритет.
